...
gz2sample_file = 'gz2sample_final1_abs_regions_counts_wvt.fits'
gz2sample = pyfits.getdata(gz2data_path+gz2sample_file)
gz2extra_file = 'gz2sample_final1extra.fits'
gz2extra = pyfits.getdata(gz2data_path+gz2extra_file)

combinedtablenames = [gz2sample_file, gz2extra_file]
gz2data_file = 'gz2sample_final1_combined.fits'
update = False
